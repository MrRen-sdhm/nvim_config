...
if &background ==? 'dark'
    ...
    highlight def Lf_hl_match  guifg=#afff5f guibg=NONE gui=bold ctermfg=85 ctermbg=NONE cterm=bold

    " the color of matching character in `And mode`
    highlight def Lf_hl_match0 guifg=#afff5f guibg=NONE gui=bold ctermfg=85 ctermbg=NONE cterm=bold
